Shader "Unlit/Clock"
{
    Properties
    {
        ...
        _OffsetHour ("OffsetHour", Vector) = (0, 0, 0, 0)
        _OffsetMin ("OffsetMin", Vector) = (0, 0, 0, 0)
        _OffsetSec ("OffsetSec", Vector) = (0, 0, 0, 0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            void RotateOffset(inout float4 vertex, float mask, float3 offset, float radians)
            {
                radians *= mask;
                offset *= mask;
                vertex.xyz -= offset;
                ...
                vertex.xy = float2(vertex.x * cosR - vertex.y * sinR, vertex.x * sinR + vertex.y * cosR);
                vertex.xyz += offset;
            }
